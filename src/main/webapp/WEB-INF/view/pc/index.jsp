...
<div class="layui-container layadmin-cmdlist-fluid">
    <div class="layui-row" style="margin: 0px auto;margin-bottom: 20px;">
        <c:forEach items="${sorttypeList}" var="item" varStatus="ss">
            <div style="border: 1px solid #ccc;margin:8px;padding: 0px;width:23%;display: inline-block;">
                <div class="layui-bg-green"
                     style="margin:3px;padding: 30px
                0px;
                 text-align:
                center;"><a
                ...
                <form class="layui-form" action="${ctx}/pc/index" method="post">
                    <div class="layui-form-item">
                        <div class="layui-inline" style="text-align: left;">
                            ...
                            <div class="layui-input-inline">
                                <button type="submit" class="layui-btn layui-btn-green"><i
