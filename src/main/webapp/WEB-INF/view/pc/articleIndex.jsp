...
<div class="layui-container layadmin-cmdlist-fluid">
    <div class="layui-row layui-col-space30 content">
        ...
        <span class="layui-breadcrumb" lay-separator="|" style="visibility: visible;">
          <a href="javascript:;" class="active">系统帖子</a><span lay-separator="">|
        </span><a href="javascript:;">${g==null?'帖子列表':'我的帖子'}</a>
        </span>
            </div>
            <div class="list-item">
                        ...
                        <div class="layui-row">
                            ...
                            <div class="layui-col-xs12 layui-col-sm8 layui-col-md7">
                                <div class="item-cont">
                                    ...
                                    <c:if test="${g==1}">
                                        <a href="${ctx}/manage/pc/deleteArticle?id=${item.id}"
                                           class="layui-btn layui-btn-danger"
                                           style="display: inline-block;margin-top: 20px;"><i
                                                class="layui-icon layui-icon-release"></i> 删除</a>
                                        <a href="${ctx}/manage/editArticle?id=${item.id}"
                                           class="layui-btn layui-btn-danger"
                                           style="display: inline-block;margin-top: 20px;"><i
                                                class="layui-icon layui-icon-release"></i>编辑</a>
                                    </c:if>
                                </div>
                            </div>
                        </div>
