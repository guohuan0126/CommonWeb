        ...
        <div class="layui-main">
            ...
            <ul class="layui-nav top_menu">
                <li class="layui-nav-item" id="showIndexHome">
                    ...
                    <a href="http://localhost:8080/CommonWeb/pc/index"><i
    ...
    <div class="layui-side layui-bg-black">
        ...
        <div class="navBar">
            <ul class="layui-nav layui-nav-tree">
                ...
                <li class="layui-nav-item layui-nav-itemed">
                    <a href="javascript:;" data-url="${ctx}/manage/questionnaireList">
                        <i class="layui-icon" data-icon=""></i>
                        <cite>问卷管理</cite>
                    </a>
                </li>
                ...
                <li class="layui-nav-item layui-nav-itemed">
                    <a href="javascript:;" data-url="${ctx}/manage/classifyList">
                        <i class="layui-icon" data-icon=""></i>
                        <cite>帖子分类管理</cite>
                    </a>
                </li>
                ...
                <li class="layui-nav-item layui-nav-itemed">
                    <a href="javascript:;" data-url="${ctx}/manage/leaveMessageList">
                        <i class="layui-icon" data-icon=""></i>
                        <cite>留言管理</cite>
                    </a>
                </li>
...
<div id="showWelcomeMsgDiv" style="display: none;">
    欢迎${sessionScope.loginuserName}登录-山西警察学院校园论坛-后台管理系统！
</div>
<!-- 移动导航 -->
