...
<form class="layui-form layui-form-pane" action="" style="width:80%;margin:0 auto;margin-top: 2%;"
    ...
    <div class="layui-input-block">
               ...
               placeholder="请输入用户名"
                              value="${result.username}" class="layui-input"/>
            </div>
    </div>
                    <div class="layui-form-item ">
    ...
    <div class="layui-input-block">
               ...
               placeholder="请输入答案1"
                              value="${result.a1}" class="layui-input"/>
            </div>
    </div>
                    <div class="layui-form-item ">
    <label class="layui-form-label">答案测试1</label>
    <div class="layui-input-block">
                <input type="text" id="a2" name="a2" lay-verify="required"
               placeholder="请输入答案2"
                              value="${result.a2}" class="layui-input"/>
            </div>
    </div>
                    <div class="layui-form-item ">
    ...
    <div class="layui-input-block">
               ...
               placeholder="请输入答案3"
                              value="${result.a3}" class="layui-input"/>
            </div>
    </div>
                    <div class="layui-form-item ">
    ...
    <div class="layui-input-block">
               ...
               placeholder="请输入答案4"
                              value="${result.a4}" class="layui-input"/>
            </div>
    </div>
                    <div class="layui-form-item ">
    ...
    <div class="layui-input-block">
               ...
               placeholder="请输入答案5"
                              value="${result.a5}" class="layui-input"/>
            </div>
    </div>
                    <div class="layui-form-item ">
    ...
    <div class="layui-input-block">
               ...
               placeholder="请输入答案6"
                              value="${result.a6}" class="layui-input"/>
            </div>
    </div>
                    <div class="layui-form-item ">
    ...
    <div class="layui-input-block">
               ...
               placeholder="请输入答案7"
                              value="${result.a7}" class="layui-input"/>
            </div>
    </div>
                    <div class="layui-form-item ">
    ...
    <div class="layui-input-block">
               ...
               placeholder="请输入答案8"
                              value="${result.a8}" class="layui-input"/>
            </div>
    </div>
                    <div class="layui-form-item ">
    ...
    <div class="layui-input-block">
               ...
               placeholder="请输入答案9"
                              value="${result.a9}" class="layui-input"/>
            </div>
    </div>
                    <div class="layui-form-item ">
    ...
    <div class="layui-input-block">
               ...
               placeholder="请输入答案10"
                              value="${result.a10}" class="layui-input"/>
            </div>
    </div>
