...
<form class="layui-form layui-form-pane" action="" style="width:80%;margin:0 auto;margin-top: 2%;"
    ...
    <div class="layui-input-block">
               ...
               placeholder="请输入用户名"
                              value="${leaveMessage.username}" class="layui-input"/>
            </div>
    </div>
                    <div class="layui-form-item ">
    ...
    <div class="layui-input-block">
               ...
               placeholder="请输入留言内容"
                              value="${leaveMessage.content}" class="layui-input"/>
            </div>
    </div>
                    <div class="layui-form-item ">
    ...
    <div class="layui-input-block">
               ...
               placeholder="请输入备注"
                              value="${leaveMessage.intro}" class="layui-input"/>
            </div>
    </div>
                    <div class="layui-form-item ">
    ...
    <div class="layui-input-block">
               ...
               placeholder="请输入图片"
                              value="${leaveMessage.picurl}" class="layui-input"/>
            </div>
    </div>
                ...
                success: function (d) {
                    if (d.code == 0) {
                        ...
                        layer.msg(msg, {time: 3000, icon: 1}, function () {
                            var url = ctx + "/manage/leaveMessageList"; //返回列表页面
