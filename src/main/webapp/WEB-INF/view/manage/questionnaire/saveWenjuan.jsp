    ...
    <div class="layui-form-item ">
        ...
        <div class="layui-input-block">
            <input type="text" id="name" name="name" lay-verify="required"
                   placeholder="请输入题目"
                   lay-verify="required" value="${questionnaire.name}" class="layui-input"/>
        </div>
    </div>
    <%--   <div class="layui-form-item ">
    ...
    <div class="layui-form-item ">
        ...
        <div class="layui-input-block">
            <input type="text" id="fenshu" name="fenshu" lay-verify="required"
                   placeholder="请输入分数"
                   lay-verify="required" value="${questionnaire.fenshu}" class="layui-input"/>
        </div>
    </div>
    <div class="layui-form-item ">
        ...
        <div class="layui-input-block">
            <input type="text" id="xuanxiang" name="xuanxiang" lay-verify="required"
                   placeholder="请输入选项"
                   lay-verify="required" value="${questionnaire.xuanxiang}" class="layui-input"/>
        </div>
    </div>
    <div class="layui-form-item ">
        ...
        <div class="layui-input-block">
            <input type="text" id="tId" name="tId" lay-verify="required" value="0"
                   placeholder="请输入所属id"
                   lay-verify="required" value="${questionnaire.TId}" class="layui-input"/>
        </div>
    </div>
                ...
                success: function (d) {
                    if (d.code == 0) {
                        ...
                        layer.msg(msg, {time: 3000, icon: 1}, function () {
                            var url = ctx + "/manage/questionnaireList"; //返回列表页面
